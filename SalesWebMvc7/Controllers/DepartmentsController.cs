...
namespace SalesWebMvc7.Controllers
{
    public class DepartmentsController : Controller
    {
        ...
        public DepartmentsController(SalesWebMvc7Context context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Department != null ? 
                          ...
                          Problem("Entity set 'SalesWebMvc7Context.Department'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'SalesWebMvc7Context.Department'  is null.");
            }
            var department = await _context.Department.FindAsync(id);
            if (department != null)
            {
